...
class TagFormatter:
    ...
    def run(self, text, mode, remove_scope, dedupe, keep_tags="", extra_character_tags=""):
        return format_tags(text, mode=mode, remove_scope=remove_scope, keep_tags=keep_tags,
                           extra_character_tags=extra_character_tags, dedupe=dedupe)
